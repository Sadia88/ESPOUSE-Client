...
const Footer = () => {
    ...
    <p><span className='text-3xl font-bold'>ESPOUSE</span> <br/> make your special day more special   <br />
                   since 2022</p> 
  </div>
  <div>
    <span className="">Contact With Us</span> 
    <div className=" footer-title flex gap-4 md:place-self-center md:justify-self-end">
